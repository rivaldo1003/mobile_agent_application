...
class __$$_initCopyWithImpl<T, $Res>
    extends _$ResultStateCopyWithImpl<T, $Res, _$_init<T>>
...
abstract class _init<T> extends ResultState<T> {
...
abstract class _loading<T> extends ResultState<T> {
...
abstract class _success<T> extends ResultState<T> {
...
abstract class _error<T> extends ResultState<T> {
